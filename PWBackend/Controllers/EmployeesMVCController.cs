...
namespace PWBackend.Controllers
{
    public class EmployeesMVCController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpID,EmpNAME,EmpTYPE,EmpMOBILE,EmpPHONE")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpID,EmpNAME,EmpTYPE,EmpMOBILE,EmpPHONE")] Employee employee)
        {
            if (ModelState.IsValid)
            {
